...
public class IbanWidget extends TextBox {
  ...
  public IbanWidget() {
    super();
    this.addKeyPressHandler(HandlerFactory.getIbanKeyPressHandler());
    this.addKeyUpHandler(HandlerFactory.getIbanKeyUpHandler());
  }
  ...
  public void setValue(final String pvalue, final boolean pfireEvents) {
    super.setValue(IbanUtil.ibanFormat(pvalue), pfireEvents);
  }
}
