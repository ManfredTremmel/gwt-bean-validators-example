 ...
 *
 */
public class SepaPresenter extends Presenter<SepaViewInterface, SepaPresenter.MyProxy> {
   ...
   */
  @Inject
  public SepaPresenter(final EventBus peventBus, final SepaViewInterface pview,
    ...
    this.service.sendSepa(this.sepaData, new AsyncCallback<SepaData>() {
      ...
      public void onFailure(final Throwable pcaught) {
        try {
          ...
          SepaPresenter.this.getView().getDriver()
