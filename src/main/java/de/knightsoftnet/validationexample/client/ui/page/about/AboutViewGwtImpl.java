 ...
 *
 */
public class AboutViewGwtImpl extends ViewImpl implements AboutViewInterface {

  /**
   * view interface.
   */
  interface AboutViewUiBinder extends UiBinder<Widget, AboutViewGwtImpl> {
  }
   ...
   */
  @Inject
  public AboutViewGwtImpl(final AboutViewUiBinder puiBinder) {
    super();
    this.initWidget(puiBinder.createAndBindUi(this));
  }

  @Override
  public final void setPresenter(final AboutPresenterInterface ppresenter) {
